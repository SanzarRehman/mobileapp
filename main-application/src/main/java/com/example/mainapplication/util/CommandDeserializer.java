...
public class CommandDeserializer {
  ...
  public CommandDeserializer(ObjectMapper objectMapper) {
   ...
   */
  public Map<String, Object> reconstructPayload(SubmitCommandRequest request, boolean useProtobufStruct) throws InvalidProtocolBufferException {
